    ...
    <section className="py-16 small:py-24 bg-brand-surface">
      <div className="content-container flex flex-col small:flex-row items-center gap-12">
        <AnimateIn variant="fade-left" className="flex-1 flex flex-col gap-6">
          <h2 className="text-brand-text text-3xl small:text-4xl font-heading font-bold leading-tight">
            Wypróbuj nasze olejki
          </h2>
          <p className="text-brand-text-muted text-base leading-relaxed max-w-lg">
          ...
          <div className="flex flex-wrap gap-4">
            <LocalizedClientLink
              ...
              className="inline-flex items-center gap-2 px-8 py-3 bg-brand-accent text-white hover:bg-brand-accent/80 transition-colors duration-300 text-sm font-medium tracking-wide w-fit"
            >
              Zamów zestaw próbek
            </LocalizedClientLink>
            <LocalizedClientLink
